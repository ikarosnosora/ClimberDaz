...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '通知类型', enum: notification_entity_1.NotificationType }),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '关联对象ID', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateNotificationDto.prototype, "relatedId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '关联对象类型', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateNotificationDto.prototype, "relatedType", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '额外数据', required: false }),
    (0, class_validator_1.IsOptional)(),
